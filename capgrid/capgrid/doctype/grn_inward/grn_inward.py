    ...
    try:
        ...
        for se_item in doc.grn_inward_item_details:
            ...
            if se_item.batch_no:
                ...
                "basic_amount" :se_item.qty*frappe.db.get_value('Item', {'item_code':item.part_number}, 'last_purchase_rate'),
                "amount" :se_item.qty*frappe.db.get_value('Item', {'item_code':item.part_number}, 'last_purchase_rate'),
                "conversion_factor": 1,
                "allow_zero_valuation_rate":1,
                "reference_purchase_receipt":doc.purchase_receipt,
